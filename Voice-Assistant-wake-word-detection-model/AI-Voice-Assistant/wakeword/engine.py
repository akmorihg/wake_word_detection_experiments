...
from neuralnet import model as md
...
class WakeWordEngine:
    ...
    def __init__(self, model_file):
        ...
        self.model_info = torch.load(model_file)
        self.model_params = self.model_info["model_params"]
        self.model_state = self.model_info["model_state_dict"]

        self.model = md.LSTMWakeWord(**self.model_params)
